...
public class PoleVisibilityRuntimeUpdater : MonoBehaviour
{
    ...
    private static void ApplySide(Transform hand, Transform pole, float side, Color poleColor, Color strapColor, Color forceColor)
    {
        ...
        AddBodyPart(hand, "Visible Pole Strap Anchor", PrimitiveType.Cube, new Vector3(0.075f * side, -0.045f, 0.04f), new Vector3(VisiblePoleStrapWidth, 0.035f, 0.115f), forceColor, new Vector3(8f, 0f, 10f * side));

        AddBodyPart(pole, "Always Visible Gameplay Pole Shaft", PrimitiveType.Cylinder, new Vector3(AlwaysVisiblePoleOutsideOffset * side, -0.78f, -0.06f), new Vector3(AlwaysVisiblePoleRadius, ProperRollerSkierRuntimeUpdater.VisiblePoleShaftLength, AlwaysVisiblePoleRadius), poleColor, new Vector3(25f, 0f, -2.5f * side));
        AddBodyPart(pole, "Cross Country Pole Strap Loop", PrimitiveType.Capsule, new Vector3(0.18f * side, -0.18f, 0.035f), new Vector3(0.035f, 0.26f, 0.035f), strapColor, new Vector3(36f, 0f, 18f * side));
        AddBodyPart(pole, "Readable Pole Plant Disc", PrimitiveType.Cylinder, new Vector3((AlwaysVisiblePoleOutsideOffset + 0.13f) * side, -1.47f, 0.54f), new Vector3(VisiblePolePlantDiscRadius, 0.018f, VisiblePolePlantDiscRadius), poleColor, new Vector3(90f, 0f, 0f));
        AddBodyPart(pole, "Pole Force Cue", PrimitiveType.Cylinder, new Vector3((AlwaysVisiblePoleOutsideOffset + 0.04f) * side, -1.03f, 0.28f), new Vector3(ForceCueRadius, 0.5f, ForceCueRadius), forceColor, new Vector3(25f, 0f, -2.5f * side));
    }
