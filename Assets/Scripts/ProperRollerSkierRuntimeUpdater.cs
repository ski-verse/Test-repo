...
public class ProperRollerSkierRuntimeUpdater : MonoBehaviour
{
    ...
    public const float RealisticHipWidth = 0.36f;
    ...
    private static void CreateProperRollerSkierVisual(Transform parent, RollerSkierAnimator animator)
    {
        ...
        var suitBackShadow = new Color(0.035f, 0.18f, 0.54f);
        ...
        AddBodyPart(parent, "Natural Hip Shelf", PrimitiveType.Capsule, new Vector3(0f, 0.988f, 0.065f), new Vector3(0.37f, 0.07f, 0.16f), suitDark, new Vector3(-9f, 0f, 90f));
        AddBodyPart(parent, "Suit Waist Seam", PrimitiveType.Cube, new Vector3(0f, 1.045f, 0.035f), new Vector3(0.31f, 0.018f, 0.16f), suitBlue, new Vector3(-9f, 0f, 0f));

        animator.leftThigh = AddBodyPart(parent, "Left Long Athletic Thigh", PrimitiveType.Capsule, new Vector3(-0.14f, 0.675f, 0.165f), new Vector3(0.09f, 0.49f, 0.09f), suitDark, new Vector3(-31f, 0f, 2.5f));
        animator.rightThigh = AddBodyPart(parent, "Right Long Athletic Thigh", PrimitiveType.Capsule, new Vector3(0.14f, 0.675f, 0.165f), new Vector3(0.09f, 0.49f, 0.09f), suitDark, new Vector3(-31f, 0f, -2.5f));
        ...
        AddBodyPart(torsoPivot, "Left Structured Shoulder", PrimitiveType.Sphere, new Vector3(-0.34f, 0.545f, -0.045f), new Vector3(0.108f, 0.085f, 0.1f), suitBlue, Vector3.zero);
        AddBodyPart(torsoPivot, "Right Structured Shoulder", PrimitiveType.Sphere, new Vector3(0.34f, 0.545f, -0.045f), new Vector3(0.108f, 0.085f, 0.1f), suitBlue, Vector3.zero);
        ...
        animator.leftArm = CreateArm(parent, "Left Connected Double-Poling Arm", new Vector3(-0.315f, 1.49f, -0.08f), -1f, suitBlue, gloveBlack);
        animator.rightArm = CreateArm(parent, "Right Connected Double-Poling Arm", new Vector3(0.315f, 1.49f, -0.08f), 1f, suitBlue, gloveBlack);
    ...
    private static Transform CreateArm(Transform parent, string name, Vector3 localPosition, float side, Color suitColor, Color gloveColor)
    {
        ...
        AddBodyPart(armPivot, "Relaxed Upper Arm", PrimitiveType.Capsule, new Vector3(-0.012f * side, -0.255f, 0.07f), new Vector3(0.066f, 0.365f, 0.066f), suitColor, new Vector3(14f, 0f, 1f * side));
        AddBodyPart(armPivot, "Long Close Forearm", PrimitiveType.Capsule, new Vector3(0.018f * side, -0.592f, 0.245f), new Vector3(0.054f, 0.445f, 0.054f), suitColor, new Vector3(29f, 0f, -1.5f * side));
        AddBodyPart(armPivot, "Glove Cuff", PrimitiveType.Capsule, new Vector3(0.03f * side, -0.8f, 0.36f), new Vector3(0.058f, 0.1f, 0.058f), gloveColor, new Vector3(22f, 0f, -1.5f * side));
        AddBodyPart(armPivot, "Hand On Pole Grip", PrimitiveType.Sphere, new Vector3(0.04f * side, -0.895f, 0.43f), new Vector3(VisibleGloveRadius, VisibleGloveRadius, VisibleGloveRadius), gloveColor, Vector3.zero);
        return armPivot;
    }
    ...
    private static Transform CreatePole(Transform parent, string name, Vector3 localPosition, float side)
    {
        ...
        AddBodyPart(polePivot, "Wrist Strap", PrimitiveType.Cube, new Vector3(0.065f * side, -0.13f, 0.04f), new Vector3(0.018f, VisiblePoleStrapLength, 0.042f), PoleGripColor, new Vector3(18f, 0f, 10f * side));
        AddBodyPart(polePivot, "Strap Loop", PrimitiveType.Capsule, new Vector3(0.082f * side, -0.22f, 0.065f), new Vector3(0.022f, 0.18f, 0.022f), PoleGripColor, new Vector3(32f, 0f, 12f * side));
