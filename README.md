...
- `SkiClassicsSkierModelBuilder` creates a new standalone low-poly Ski Classics roller skier model from scratch, without modifying or replacing the existing gameplay skier; it includes human proportions, visible shoulders, hips, thighs, calves, roller ski boots, bindings, classic roller skis, visible wheels, pole grip attachment points, straps, baskets, and pressure highlights
