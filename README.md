...
- Highly visible SkiErg-inspired double-poling animation with significantly deeper torso lean, roughly doubled hand travel, stronger recovery, and a much more obvious pole plant while preserving speed-scaled cycle timing
