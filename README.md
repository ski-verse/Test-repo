...
- Stronger synchronized double-poling animation with both arms moving together, parallel pole plant, forward body lean, return phase, and speed-scaled cycle timing
