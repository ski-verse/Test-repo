...
- A more realistic low-poly roller skier resembling an endurance Vasalopp/Ski Classics athlete, with longer legs, a narrower waist, broader relaxed shoulders, a slight V-shape torso, smaller head, small forward lean from the hips, neutral head position, classic roller ski binding placement, visible roller ski frames, larger visible wheels, longer front wheel reach, and longer slender poles
